                ...
                <View style={styles.postContainer}>
                    <View style={styles.postHeader}>
                        ...
                        <View style={styles.postUser}>
                            ...
                            <Image source={{ uri: post.userProfilePicture || 'https://via.placeholder.com/40' }} style={styles.postUserImage}/>
                        </View>
                    </View>
                    <View style={styles.postBibleInformation}>
                        {post.BibleInformation.map((verse, index) => (
                            <View key={index}>
                                <RenderHTML contentWidth={200} source={{ html: verse.BibleText }} />
